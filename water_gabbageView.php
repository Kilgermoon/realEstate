...
$paid = $conn->query("SELECT SUM(amount) as paid FROM water_gabbage_payments where tenant_id =".$_GET['id']);
$last_payment = $conn->query("SELECT * FROM water_gabbage_payments where tenant_id =".$_GET['id']." order by unix_timestamp(date_created) desc limit 1");
		...
		<div class="row">
			...
			<div class="col-md-8">
				...
				<table class="table table-condensed table-striped">
					...
					<tbody>
						<?php 
						$payments = $conn->query("SELECT * FROM  water_gabbage_payments where tenant_id = $id");
